 ...
 */};const S="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,M=(t,e,i=null)=>{for(;e!==i;){const i=e.nextSibling;t.removeChild(e),e=i}},P=`{{lit-${String(Math.random()).slice(2)}}}`,N=`\x3c!--${P}--\x3e`,$=new RegExp(`${P}|${N}`);class C{constructor(t,e){this.parts=[],this.element=e;const i=[],s=[],r=document.createTreeWalker(e.content,133,null,!1);let o=0,n=-1,a=0;const{strings:l,values:{length:d}}=t;for(;a<d;){const t=r.nextNode();if(null!==t){if(n++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:i}=e;let s=0;for(let t=0;t<i;t++)H(e[t].name,"$lit$")&&s++;for(;s-- >0;){const e=l[a],i=E.exec(e)[2],s=i.toLowerCase()+"$lit$",r=t.getAttribute(s);t.removeAttribute(s);const o=r.split($);this.parts.push({type:"attribute",index:n,name:i,strings:o}),a+=o.length-1}}"TEMPLATE"===t.tagName&&(s.push(t),r.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(P)>=0){const s=t.parentNode,r=e.split($),o=r.length-1;for(let e=0;e<o;e++){let i,o=r[e];if(""===o)i=V();else{const t=E.exec(o);null!==t&&H(t[2],"$lit$")&&(o=o.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),i=document.createTextNode(o)}s.insertBefore(i,t),this.parts.push({type:"node",index:++n})}""===r[o]?(s.insertBefore(V(),t),i.push(t)):t.data=r[o],a+=o}}else if(8===t.nodeType)if(t.data===P){const e=t.parentNode;null!==t.previousSibling&&n!==o||(n++,e.insertBefore(V(),t)),o=n,this.parts.push({type:"node",index:n}),null===t.nextSibling?t.data="":(i.push(t),n--),a++}else{let e=-1;for(;-1!==(e=t.data.indexOf(P,e+1));)this.parts.push({type:"node",index:-1}),a++}}else r.currentNode=s.pop()}for(const t of i)t.parentNode.removeChild(t)}}const H=(t,e)=>{const i=t.length-e.length;return i>=0&&t.slice(i)===e},k=t=>-1!==t.index,V=()=>document.createComment(""),E=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function z(t,e){const{element:{content:i},parts:s}=t,r=document.createTreeWalker(i,133,null,!1);let o=L(s),n=s[o],a=-1,l=0;const d=[];let h=null;for(;r.nextNode();){a++;const t=r.currentNode;for(t.previousSibling===h&&(h=null),e.has(t)&&(d.push(t),null===h&&(h=t)),null!==h&&l++;void 0!==n&&n.index===a;)n.index=null!==h?-1:n.index-l,o=L(s,o),n=s[o]}d.forEach(t=>t.parentNode.removeChild(t))}const T=t=>{let e=11===t.nodeType?0:1;const i=document.createTreeWalker(t,133,null,!1);for(;i.nextNode();)e++;return e},L=(t,e=-1)=>{for(let i=e+1;i<t.length;i++){const e=t[i];if(k(e))return i}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const A=new WeakMap,O=t=>"function"==typeof t&&A.has(t),D={},R={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function et(t){let e=it.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},it.set(t.type,e));let i=e.stringsArray.get(t.strings);if(void 0!==i)return i;const s=t.strings.join(P);return i=e.keyString.get(s),void 0===i&&(i=new C(t,t.getTemplateElement()),e.keyString.set(s,i)),e.stringsArray.set(t.strings,i),i}const it=new Map,st=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const vt=t=>e=>"function"==typeof e?((t,e)=>(window.customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:i,elements:s}=e;return{kind:i,elements:s,finisher(e){window.customElements.define(t,e)}}})(t,e),yt=(t,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?Object.assign(Object.assign({},e),{finisher(i){i.createProperty(e.key,t)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(i){i.createProperty(e.key,t)}};function ft(t){return(e,i)=>void 0!==i?((t,e,i)=>{e.constructor.createProperty(i,t)})(t,e,i):yt(t,e)}function bt(t){return ft({attribute:!1,hasChanged:null==t?void 0:t.hasChanged})}const wt=(t,e,i)=>{Object.defineProperty(e,i,t)},xt=(t,e)=>({kind:"method",placement:"prototype",key:e.key,descriptor:t}),St=Element.prototype,Mt=St.msMatchesSelector||St.webkitMatchesSelector;
/**
@license
...
*/
const Pt=window.ShadowRoot&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Nt=Symbol();class $t{constructor(t,e){if(e!==Nt)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return void 0===this._styleSheet&&(Pt?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const Ct=(t,...e)=>{const i=e.reduce((e,i,s)=>e+(t=>{if(t instanceof $t)return t.cssText;if("number"==typeof t)return t;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(i)+t[s+1],t[0]);return new $t(i,Nt)};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const Ht={};class kt extends _t{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,i)=>t.reduceRight((t,i)=>Array.isArray(i)?e(i,t):(t.add(i),t),i),i=e(t,new Set),s=[];i.forEach(t=>s.unshift(t)),this._styles=s}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map(t=>{if(t instanceof CSSStyleSheet&&!Pt){const e=Array.prototype.slice.call(t.cssRules).reduce((t,e)=>t+e.cssText,"");return new $t(String(e),Nt)}return t})}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Pt?this.renderRoot.adoptedStyleSheets=t.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==Ht&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return Ht}}function Vt(t){if(!t||"object"!=typeof t)return t;if("[object Date]"==Object.prototype.toString.call(t))return new Date(t.getTime());if(Array.isArray(t))return t.map(Vt);var e={};return Object.keys(t).forEach((function(i){e[i]=Vt(t[i])})),e}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */kt.finalized=!0,kt.render=(t,e,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const s=i.scopeName,r=st.has(e),o=lt&&11===e.nodeType&&!!e.host,n=o&&!ct.has(s),a=n?document.createDocumentFragment():e;if(((t,e,i)=>{let s=st.get(e);void 0===s&&(M(e,e.firstChild),st.set(e,s=new F(Object.assign({templateFactory:et},i))),s.appendInto(e)),s.setValue(t),s.commit()})(t,a,Object.assign({templateFactory:dt(s)},i)),n){const t=st.get(a);st.delete(a);const i=t.value instanceof Y?t.value.template:void 0;ut(s,a,i),M(e,e.firstChild),e.appendChild(a),st.set(e,t)}!r&&o&&window.ShadyCSS.styleElement(e.host)};const Et=new WeakMap,zt=t=>(...e)=>{const i=t(...e);return Et.set(i,!0),i},Tt=t=>"function"==typeof t&&Et.has(t),Lt="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,At=(t,e,i=null)=>{for(;e!==i;){const i=e.nextSibling;t.removeChild(e),e=i}},Ot={},Dt={},Rt=`{{lit-${String(Math.random()).slice(2)}}}`,Yt=`\x3c!--${Rt}--\x3e`,It=t=>-1!==t.index,Xt=()=>document.createComment(""),jt=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class Wt{constructor(t,e,i){this.__parts=[],this.template=t,this.processor=e,this.options=i}update(t){let e=0;for(const i of this.__parts)void 0!==i&&i.setValue(t[e]),e++;for(const t of this.__parts)void 0!==t&&t.commit()}_clone(){const t=Lt?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),e=[],i=this.template.parts,s=document.createTreeWalker(t,133,null,!1);let r,o=0,n=0,a=s.nextNode();for(;o<i.length;)if(r=i[o],It(r)){for(;n<r.index;)n++,"TEMPLATE"===a.nodeName&&(e.push(a),s.currentNode=a.content),null===(a=s.nextNode())&&(s.currentNode=e.pop(),a=s.nextNode());if("node"===r.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(a.previousSibling),this.__parts.push(t)}else this.__parts.push(...this.processor.handleAttributeExpressions(a,r.name,r.strings,this.options));o++}else this.__parts.push(void 0),o++;return Lt&&(document.adoptNode(t),customElements.upgrade(t)),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class me{constructor(t){this.classes=new Set,this.changed=!1,this.element=t;const e=(t.getAttribute("class")||"").split(/\s+/);for(const t of e)this.classes.add(t)}add(t){this.classes.add(t),this.changed=!0}remove(t){this.classes.delete(t),this.changed=!0}commit(){if(this.changed){let t="";this.classes.forEach(e=>t+=e+" "),this.element.setAttribute("class",t)}}}const _e=new WeakMap,ve=zt(t=>e=>{if(!(e instanceof Gt)||e instanceof ee||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:i}=e,{element:s}=i;let r=_e.get(e);void 0===r&&(s.setAttribute("class",i.strings.join(" ")),_e.set(e,r=new Set));const o=s.classList||new me(s);r.forEach(e=>{e in t||(o.remove(e),r.delete(e))});for(const e in t){const i=t[e];i!=r.has(e)&&(i?(o.add(e),r.add(e)):(o.remove(e),r.delete(e)))}"function"==typeof o.commit&&o.commit()}),ye=(t,e,i={})=>{t.dispatchEvent(new CustomEvent(e,{detail:i}))},fe=(t,e)=>{if(t.type.startsWith("touch")){if(void 0===e)return;const i=be(t,e);return{x:i.x,y:i.y}}return{x:t.clientX,y:t.clientY}},be=(t,e)=>{const i=t.targetTouches&&Array.prototype.find.call(t.targetTouches,t=>e===t.identifier)||t.changedTouches&&Array.prototype.find.call(t.changedTouches,t=>e===t.identifier);return{x:i.clientX,y:i.clientY}};let we="";const xe=(t,e)=>(we||(we=["matches","webkitMatchesSelector","mozMatchesSelector","msMatchesSelector","oMatchesSelector"].find(e=>Se(t[e]))),!(!we||!Se(t[we]))&&t[we](e)),Se=t=>"function"==typeof t||"[object Function]"===Object.prototype.toString.call(t);var Me=function(t,e,i,s){var r,o=arguments.length,n=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(n=(o<3?r(n):o>3?r(e,i,n):r(e,i))||n);return o>3&&n&&Object.defineProperty(e,i,n),n};let Pe=class extends kt{constructor(){super(...arguments),this.disabled=!1,this._dragging=!1}firstUpdated(){this.addEventListener("mousedown",this._dragStart.bind(this),{capture:!0,passive:!1}),this.addEventListener("touchstart",this._dragStart.bind(this),{capture:!0,passive:!1}),document.addEventListener("mousemove",this._drag.bind(this),{capture:!0,passive:!1}),document.addEventListener("touchmove",this._drag.bind(this),{capture:!0,passive:!1}),document.addEventListener("mouseup",this._dragEnd.bind(this),{capture:!0,passive:!1}),document.addEventListener("touchcancel",this._dragEnd.bind(this),{capture:!0,passive:!1}),document.addEventListener("touchend",this._dragEnd.bind(this),{capture:!0,passive:!1})}render(){return ot`<slot></slot>`}_dragStart(t){if(t.type.startsWith("mouse")&&0!==t.button||this.disabled)return;if(this.handle&&!((t,e,i)=>{const s=t.composedPath().reverse();for(;s.length;){const t=s.pop();if(xe(t,e))return!0;if(t===i)return!1}return!1})(t,this.handle,this.offsetParent))return;var e;t.preventDefault(),t.stopPropagation(),"touchstart"===t.type&&(this._touchIdentifier=(e=t).targetTouches&&e.targetTouches[0]?e.targetTouches[0].identifier:e.changedTouches&&e.changedTouches[0]?e.changedTouches[0].identifier:0);const i=fe(t,this._touchIdentifier);i&&(this.startX=i.x,this.startY=i.y,this._dragging=!0,ye(this,"dragStart",{startX:this.startX,startY:this.startY}))}_drag(t){if(!this._dragging||this.disabled)return;t.preventDefault(),t.stopPropagation();const e=fe(t,this._touchIdentifier);if(!e)return;let i=e.x-this.startX,s=e.y-this.startY;this.grid&&(i=Math.round(i/this.grid[0])*this.grid[0],s=Math.round(s/this.grid[1])*this.grid[1]),(i||s)&&ye(this,"dragging",{deltaX:i,deltaY:s})}_dragEnd(t){this._dragging&&!this.disabled&&(t.preventDefault(),t.stopPropagation(),this._touchIdentifier=void 0,this._dragging=!1,ye(this,"dragEnd"))}};Me([ft({type:Array})],Pe.prototype,"grid",void 0),Me([ft({type:Boolean,reflect:!0})],Pe.prototype,"disabled",void 0),Me([ft()],Pe.prototype,"handle",void 0),Pe=Me([vt("lit-draggable")],Pe);var Ne=function(t,e,i,s){var r,o=arguments.length,n=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(n=(o<3?r(n):o>3?r(e,i,n):r(e,i))||n);return o>3&&n&&Object.defineProperty(e,i,n),n};let $e=class extends kt{constructor(){super(...arguments),this.disabled=!1}render(){return ot`
      <slot></slot>
      ...
      ${this.disabled?"":ot`
          ...
          `}
    `}_resizeStart(t){t.preventDefault(),t.stopPropagation(),this.startWidth=this.clientWidth,this.startHeight=this.clientHeight,ye(this,"resizeStart")}_resize(t){if(t.preventDefault(),t.stopPropagation(),void 0===this.startWidth||void 0===this.startHeight)return;const{deltaX:e,deltaY:i}=t.detail;if(0===i&&0===e)return;const s=this.startWidth+e,r=this.startHeight+i;ye(this,"resize",{width:s,height:r,deltaX:e,deltaY:i})}_resizeEnd(t){t.preventDefault(),t.stopPropagation(),this.startWidth=void 0,this.startHeight=void 0,ye(this,"resizeEnd")}static get styles(){return Ct`
      :host {
        position: relative;
        display: block;
      }
    ...
    `}};Ne([ft({attribute:!1})],$e.prototype,"handle",void 0),Ne([ft({type:Boolean})],$e.prototype,"disabled",void 0),$e=Ne([vt("lit-resizable")],$e);var Ce=function(t,e,i,s){var r,o=arguments.length,n=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(n=(o<3?r(n):o>3?r(e,i,n):r(e,i))||n);return o>3&&n&&Object.defineProperty(e,i,n),n};let He=class extends kt{constructor(){super(...arguments),this.minWidth=1,this.minHeight=1,this.isDraggable=!0,this.isResizable=!0,this._isDragging=!1,this._isResizing=!1,this._firstLayoutFinished=!1}updated(t){if(t.has("parentWidth")||t.has("margin")||t.has("columns")||t.has("containerPadding")||t.has("minHeight")||t.has("minWidth")||t.has("maxWidth")||t.has("maxHeight")||t.has("rowHeight")||t.has("posX")||t.has("_isDragging")&&!this._isDragging){this._columnWidth=(this.parentWidth-this.margin[0]*(this.columns-1)-2*this.containerPadding[0])/this.columns,this._fullColumnWidth=this._columnWidth+this.margin[0],this._fullRowHeight=this.rowHeight+this.margin[1],this._minWidthPX=this._fullColumnWidth*this.minWidth-this.margin[0];const t=void 0!==this.maxWidth?Math.min(this.maxWidth,this.columns-this.posX):this.columns-this.posX;this._maxWidthPX=this._fullColumnWidth*t-this.margin[0],this._minHeightPX=this._fullRowHeight*this.minHeight-this.margin[1],this._maxHeightPX=this._fullRowHeight*(this.maxHeight||1/0)-this.margin[1]}this._isDragging||(this._itemLeftPX=Math.round(this.posX*this._fullColumnWidth+this.containerPadding[0]),this._itemTopPX=this.parentWidth?Math.round(this.posY*this._fullRowHeight+this.containerPadding[1]):0,this._isResizing||(this._itemWidthPX=this.width*this._columnWidth+Math.max(0,this.width-1)*this.margin[0],this._itemHeightPX=this.height*this.rowHeight+Math.max(0,this.height-1)*this.margin[1],!this._firstLayoutFinished&&this.parentWidth>0&&setTimeout(()=>this._firstLayoutFinished=!0,200)))}render(){var t;let e=ot`<slot></slot>`;if(this.isDraggable&&(e=ot`
      ...
      `}return ot`
      <div
        class="grid-item-wrapper ${ve({dragging:this._isDragging,resizing:this._isResizing,finished:this._firstLayoutFinished})}"
        style="transform: translate(${this._itemLeftPX}px, ${this._itemTopPX}px); width: ${this._itemWidthPX}px; height: ${this._itemHeightPX}px"
      >
        ${e}
      </div>
    `}_resizeStart(){this.isDraggable=!1,this._isResizing=!0,this._isDragging=!1,ye(this,"resizeStart")}_resize(t){if(!this._isResizing)return;let{width:e,height:i}=t.detail;e=Math.max(this._minWidthPX,e),e=Math.min(this._maxWidthPX,e),i=Math.max(this._minHeightPX,i),i=Math.min(this._maxHeightPX,i),this._itemWidthPX=e,this._itemHeightPX=i;const s=Math.round((e+this.margin[0])/this._fullColumnWidth),r=Math.round((i+this.margin[1])/this._fullRowHeight);s===this.width&&r===this.height||ye(this,"resize",{newWidth:s,newHeight:r})}_resizeEnd(){this.isDraggable=!0,this._isResizing=!1,ye(this,"resizeEnd")}_dragStart(){if(!this.isDraggable)return;const t=this.gridItem.getBoundingClientRect(),e=this.offsetParent.getBoundingClientRect();this._startLeft=t.left-e.left,this._startTop=t.top-e.top,this._startPosX=this.posX,this._startPosY=this.posY,this._isDragging=!0,ye(this,"dragStart")}_drag(t){if(void 0===this._startPosX||void 0===this._startPosY||void 0===this._startLeft||void 0===this._startTop||!this.isDraggable)return;const{deltaX:e,deltaY:i}=t.detail;this._itemLeftPX=this._startLeft+e,this._itemTopPX=this._startTop+i;const s=Math.round(e/this._fullColumnWidth),r=Math.round(i/this._fullRowHeight);if(!r&&!s)return;let o=this._startPosX+s,n=this._startPosY+r;o=Math.max(0,o),n=Math.max(0,n),o=Math.min(this.columns-this.width,o),ye(this,"dragging",{newPosX:o,newPosY:n})}_dragEnd(){this._isDragging=!1,this._startLeft=void 0,this._startTop=void 0,this._startPosX=void 0,this._startPosY=void 0,ye(this,"dragEnd")}static get styles(){return Ct`
      .grid-item-wrapper {
        position: absolute;
    ...
    `}};var ke,Ve;Ce([ft({type:Number})],He.prototype,"width",void 0),Ce([ft({type:Number})],He.prototype,"height",void 0),Ce([ft({type:Number})],He.prototype,"posX",void 0),Ce([ft({type:Number})],He.prototype,"posY",void 0),Ce([ft({type:Number})],He.prototype,"rowHeight",void 0),Ce([ft({type:Number})],He.prototype,"columns",void 0),Ce([ft({type:Number})],He.prototype,"parentWidth",void 0),Ce([ft({type:Array})],He.prototype,"margin",void 0),Ce([ft({type:Array})],He.prototype,"containerPadding",void 0),Ce([ft({type:Number})],He.prototype,"minWidth",void 0),Ce([ft({type:Number})],He.prototype,"minHeight",void 0),Ce([ft({type:Number})],He.prototype,"maxWidth",void 0),Ce([ft({type:Number})],He.prototype,"maxHeight",void 0),Ce([ft({type:Boolean})],He.prototype,"isDraggable",void 0),Ce([ft({type:Boolean})],He.prototype,"isResizable",void 0),Ce([ft({type:Boolean})],He.prototype,"_isDragging",void 0),Ce([ft({type:Boolean})],He.prototype,"_isResizing",void 0),Ce([ft({type:Boolean})],He.prototype,"_firstLayoutFinished",void 0),Ce([ft({attribute:!1})],He.prototype,"resizeHandle",void 0),Ce([ft({attribute:!1})],He.prototype,"dragHandle",void 0),Ce([ft()],He.prototype,"key",void 0),Ce([(ke=".grid-item-wrapper",(t,e)=>{const i={get(){return this.renderRoot.querySelector(ke)},enumerable:!0,configurable:!0};if(Ve){const t="symbol"==typeof e?Symbol():"__"+e;i.get=function(){return void 0===this[t]&&(this[t]=this.renderRoot.querySelector(ke)),this[t]}}return void 0!==e?wt(i,t,e):xt(i,t)})],He.prototype,"gridItem",void 0),Ce([bt()],He.prototype,"_itemTopPX",void 0),Ce([bt()],He.prototype,"_itemLeftPX",void 0),Ce([bt()],He.prototype,"_itemWidthPX",void 0),Ce([bt()],He.prototype,"_itemHeightPX",void 0),He=Ce([vt("lit-grid-item")],He);const Ee=(t,e)=>t.key!==e.key&&(!(t.posX+t.width<=e.posX)&&(!(t.posX>=e.posX+e.width)&&(!(t.posY+t.height<=e.posY)&&!(t.posY>=e.posY+e.height)))),ze=(t,e)=>{for(const i of t)if(Ee(i,e))return i},Te=(t,e,i)=>{e.posY+=1;for(let s=t.map(t=>t.key).indexOf(e.key)+1;s<t.length;s++){const r=t[s];if(r.posY>e.posY+e.height)break;Ee(e,r)&&Te(t,r,i+e.height)}e.posY=i},Le=t=>t.slice(0).sort((function(t,e){return t.posY>e.posY||t.posY===e.posY&&t.posX>e.posX?1:t.posY===e.posY&&t.posX===e.posX?0:-1})),Ae=(t,e,i=!1)=>{let s;return function(...r){const o=this,n=i&&!s;clearTimeout(s),s=setTimeout(()=>{s=null,i||t.apply(o,r)},e),n&&t.apply(o,r)}},Oe=(t,e,i)=>{if(1===t.width){const t=Math.min(...e);return{posX:e.indexOf(t),posY:t}}const s=[],r=i+1-t.width;for(let i=0;i<r;i++){const r=e.slice(i,i+t.width);s[i]=Math.max(...r)}const o=Math.min(...s);return{posX:s.indexOf(o),posY:o}},De=(t,e,i,s,r)=>{if(r){r=!1;const o={posX:i.posX,posY:Math.max(i.height-e.posY,0),width:i.width,height:i.height,key:"-1"};if(!ze(t,o))return Re(t,i,void 0,o.posY,s,r)}return Re(t,i,void 0,i.posY+1,s,r)},Re=(t,e,i,s,r,o)=>{if(e.posY===s&&e.posX===i)return t;const n=e.posY;void 0!==i&&(e.posX=i),void 0!==s&&(e.posY=s),e.hasMoved=!0;let a=Le(t);void 0!==s&&n>=s&&(a=a.reverse());const l=((t,e)=>t.filter(t=>Ee(t,e)))(a,e),d=t.findIndex(t=>t.key===e.key);t[d]=e;for(let i=0,s=l.length;i<s;i++){const s=l[i];s.hasMoved||(t=De([...t],e,s,r,o))}return t};var Ye=function(t,e,i,s){var r,o=arguments.length,n=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(n=(o<3?r(n):o>3?r(e,i,n):r(e,i))||n);return o>3&&n&&Object.defineProperty(e,i,n),n};let Ie=class extends kt{constructor(){super(...arguments),this.sortStyle="masonry",this.margin=[10,10],this.containerPadding=[20,20],this.rowHeight=30,this.columns=12,this.dragDisabled=!1,this.resizeDisabled=!1,this.resizing=!1,this.dragging=!1,this._width=0,this._layout=[]}get _layoutHeight(){const t=(t=>{let e=0;for(const i of t){const t=i.posY+i.height;e=t>e?t:e}return e})(this._layout);return t*this.rowHeight+(t-1)*this.margin[1]+2*this.containerPadding[1]}disconnectedCallback(){this._resizeObserver&&this._resizeObserver.disconnect()}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>this._attachObserver())}updated(t){super.updated(t),t.has("layout")?this._setupLayout():t.has("columns")&&this._updateLayout(Vt(this.layout)),this.style.height=this._layoutHeight+"px"}render(){var t;return(null===(t=this._layout)||void 0===t?void 0:t.length)&&this.itemRenderer?ot`
    ...
    `}_speakerClass(t){var e;const i=["chip"];return t===this._active&&i.push("active"),"playing"===(null===(e=this.hass.states[t])||void 0===e?void 0:e.state)&&i.push("playing"),i.join(" ")}_selectSpeaker(t){this._selected=t}_setProvider(t){this._provider=t.target.value}_artUrl(t){return t.startsWith("/")?this.hass.hassUrl(t):t}_call(t,e={}){return this.hass.callService("media_player",t,Object.assign({entity_id:this._active},e))}async _control(t){this._error=void 0;try{await this._call(t),this._refreshSoon([this._active])}catch(t){this._error=t.message||String(t)}}_refreshSoon(t){Qe.forEach(e=>setTimeout(()=>{this.hass.callService("homeassistant","update_entity",{entity_id:t}).catch(()=>{})},e))}_changeVolume(t){const e=Math.min(100,Math.max(0,t))/100;this._call("volume_set",{volume_level:e})}_icon(t){return ot`
    ...
    `}_search(t){t.preventDefault();const e=this._query.trim();e&&(this._playMusic(e),this._query="")}async _playMusic(t,e){const i=e||this._provider,s=t.replace(/^play\s+/i,""),r="CLOUDPLAYER"===i?void 0:Ke[i],o=this._active;this._error=void 0;let n=o,a=r?`play ${s} on ${r}`:"play "+s;if(this._isGroup(o)){const t=this._commandSpeaker();if(!t)return void(this._error="No available Alexa speaker to send the request through.");n=t,a=`play ${s}${r?" from "+r:""} on ${this._groupName(o)}`}try{await this.hass.callService("media_player","play_media",{entity_id:n,media_content_id:a,media_content_type:"custom"}),this._refreshSoon([o])}catch(t){this._error=`Couldn't play "${s}": ${t.message||t}`}}static get styles(){return Ct`
      ha-card {
    ...
    `}};t([ft({attribute:!1})],ti.prototype,"hass",void 0),t([bt()],ti.prototype,"_config",void 0),t([bt()],ti.prototype,"_selected",void 0),t([bt()],ti.prototype,"_provider",void 0),t([bt()],ti.prototype,"_query",void 0),t([bt()],ti.prototype,"_error",void 0),ti=t([vt("alexa-music-player-card")],ti),window.customCards=window.customCards||[],window.customCards.push({type:"alexa-music-player-card",name:"Alexa Music Player",description:"Pick an Alexa speaker, control playback and play music from Amazon Music, Spotify and more.",preview:!1});let ei=class extends kt{getCardSize(){return this._assignedNodes?w(this._assignedNodes[0]):1}render(){return ne`
      <slot></slot>
    ...
    `}_editCard(){x(this,"ll-edit-card",{path:this.path})}_deleteCard(){x(this,"ll-delete-card",{path:this.path})}static get styles(){return Ct`
      slot {
        pointer-events: none;
        z-index: 0;
      }
    ...
    `}};t([ft({attribute:!1})],ei.prototype,"hass",void 0),t([ft({attribute:!1})],ei.prototype,"lovelace",void 0),t([ft({type:Array})],ei.prototype,"path",void 0),t([function(t="",e=!1,i=""){return(s,r)=>{const o={get(){const s="slot"+(t?`[name=${t}]`:":not([name])"),r=this.renderRoot.querySelector(s);let o=r&&r.assignedNodes({flatten:e});return o&&i&&(o=o.filter(t=>t.nodeType===Node.ELEMENT_NODE&&t.matches?t.matches(i):Mt.call(t,i))),o},enumerable:!0,configurable:!0};return void 0!==r?wt(o,s,r):xt(o,s)}}()],ei.prototype,"_assignedNodes",void 0),ei=t([vt("hui-grid-card-options")],ei);const ii=[2,6,9,12],si=document.createElement("div");si.style.cssText="width: 100%; height: 100%; cursor: se-resize; fill: var(--primary-text-color)",si.innerHTML='\n  <svg\n    viewBox="0 0 24 24"\n    preserveAspectRatio="xMidYMid meet"\n    focusable="false"\n  >\n    <g><path d=M22,22H20V20H22V22M22,18H20V16H22V18M18,22H16V20H18V22M18,18H16V16H18V18M14,22H12V20H14V22M22,14H20V12H22V14Z></path></g>\n  </svg>\n';let ri=class extends kt{constructor(){super(),this.cards=[],this.badges=[],this._cards={},this._createColumnsIteration=0,this._itemRenderer=t=>this._cards?ot`
      ${this._cards[t]}
    `:ot``,this.addEventListener("iron-resize",t=>t.stopPropagation())}setConfig(t){this._config=t}render(){var t,e,i,s,r;return ot`
      ...
      ${(null===(i=this.lovelace)||void 0===i?void 0:i.editMode)?ot`
            <mwc-fab
              class=${ve({rtl:(s=this.hass,r=s.language||"en",s.translationMetadata.translations[r]&&s.translationMetadata.translations[r].isRTL||!1)})}
    ...
    `}};t([ft({attribute:!1})],ri.prototype,"hass",void 0),t([ft({attribute:!1})],ri.prototype,"lovelace",void 0),t([ft({type:Number})],ri.prototype,"index",void 0),t([ft({attribute:!1})],ri.prototype,"cards",void 0),t([ft({attribute:!1})],ri.prototype,"badges",void 0),t([bt()],ri.prototype,"_columns",void 0),t([bt()],ri.prototype,"_layout",void 0),t([bt()],ri.prototype,"_cards",void 0),ri=t([vt("grid-dnd")],ri);export{ri as GridView};
